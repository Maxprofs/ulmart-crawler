...
def main():
    components = [
        ('http://www.cpubenchmark.net/high_end_cpus.html', 'data/benchmark/cpu.json', 'cpu'),
        ('http://www.videocardbenchmark.net/high_end_gpus.html', 'data/benchmark/gpu.json', 'gpu'),
        ('http://www.harddrivebenchmark.net/high_end_drives.html', 'data/benchmark/drives.json', 'drives'),
        ('http://www.memorybenchmark.net/popular.html', 'data/benchmark/memory.json', 'memory')
    ]
